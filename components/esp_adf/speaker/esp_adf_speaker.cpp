...
void ESPADFSpeaker::setup() {
 ...
 // Find the key for the generic volume sensor
  ...
  ESP_ERROR_CHECK(adc_oneshot_config_channel(&adc1_handle, ADC_CHANNEL_7, &ch_config));
  adc_cali_handle_t adc1_cali_handle = NULL;
  bool adc_calibrated = setup_adc_calibration(ADC_UNIT_1, ADC_CHANNEL_7, ADC_ATTEN_DB_12, &adc1_cali_handle);
